        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto mb-12">
            ...
            <p className="text-lg md:text-xl text-stone-600 font-light leading-relaxed max-w-2xl mx-auto">
              Experience the pulse of London through our carefully curated collection of live
              traffic cameras, offering intimate glimpses into the city's ever-flowing rhythm.
            </p>
          </div>
          ...
          <div className="mt-20 pt-8 border-t border-stone-200/50 text-center">
            <p className="text-sm text-stone-500 font-light">
              Camera feeds courtesy of <span className="font-medium">Transport for London</span>
            </p>
          </div>
        </div>
      </div>

			...
			<div className="space-y-8">
				...
				{data && (
					<div className="space-y-8">
						...
						{/* Death Seasonality Metrics */}
						<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
							<div className="bg-white/60 backdrop-blur-sm rounded-3xl shadow-xl border border-stone-200/50 p-8 hover:bg-white/70 transition-all duration-300">
								<h3 className="font-serif text-xl text-stone-800 mb-3">
									Death Seasonality Strength
								</h3>
								<p className="text-4xl font-light text-red-700 mb-2">
									{(data.analysis.deathSeasonalityStrength * 100).toFixed(1)}%
								</p>
								<p className="text-stone-600 text-sm font-light">
									Death variation coefficient across months
								</p>
							</div>
							<div className="bg-white/60 backdrop-blur-sm rounded-3xl shadow-xl border border-stone-200/50 p-8 hover:bg-white/70 transition-all duration-300">
								<h3 className="font-serif text-xl text-stone-800 mb-3">
								...
								<p className="text-4xl font-light text-red-600 mb-2">
									{data.analysis.patterns[data.analysis.deathPeakMonth - 1]
										?.monthName || "N/A"}
								</p>
								<p className="text-stone-600 text-sm font-light">
							...
							<div className="bg-white/60 backdrop-blur-sm rounded-3xl shadow-xl border border-stone-200/50 p-8 hover:bg-white/70 transition-all duration-300">
								...
								<p className="text-4xl font-light text-green-600 mb-2">
									{data.analysis.patterns[data.analysis.deathTroughMonth - 1]
										?.monthName || "N/A"}
								</p>
								<p className="text-stone-600 text-sm font-light">
						...
						{/* Monthly Death Patterns Chart */}
						<div className="bg-white/60 backdrop-blur-sm rounded-3xl shadow-xl border border-stone-200/50 p-8">
							<h2 className="font-serif text-2xl text-stone-800 mb-6">
								Monthly Death Patterns
							</h2>
							<div className="h-80">
								<ResponsiveContainer width="100%" height="100%">
									<BarChart data={data.analysis.patterns}>

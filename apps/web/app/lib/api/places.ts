...
import { CACHE_TIME, URLS, api, queryKeys } from "./base";
...
// Remove this function as it's attempting to use a hook outside of component context
// async function fetchPlace(id: string) {
// 	const { data } = await useGetPlace(id).queryFn();
// 	return data;
// }
